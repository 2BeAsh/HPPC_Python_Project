...
class Data:
    def __init__(self, Filename='data/mc_ggH_16_13TeV_Zee_EGAM1_calocells_16249871.csv'):
        ...
        self.means_sig = self.data.loc[self.signal].mean(axis=0)
        self.means_bckg = self.data.loc[~self.signal].mean(axis=0)
